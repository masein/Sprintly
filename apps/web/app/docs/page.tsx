              ...
              <table className="mono w-full text-xs">
                ...
                <tbody className="text-chrome-dim">
                  {[
                    ...
                    ["Parent (id) / Parent key", "resolved to the parent issue — by key, or numeric id mapped back to its row"],
                    ["Sub-task → parent", "subtask nested under its parent (warns + summarises if absent)"],
