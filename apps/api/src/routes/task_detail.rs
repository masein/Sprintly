...
pub struct CommentDto {
    ...
    pub author_avatar_style: Option<String>,
...
async fn list_comments(
    ...
    let items: Vec<CommentDto> = rows
        ...
        .map(|r| CommentDto {
            ...
            author_avatar_style: r.author_avatar_style,
            author_avatar_seed: r.author_avatar_seed,
