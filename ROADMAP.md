...
**PRs:** #27 (inbound webhook commit/PR → task linking), #28 (auto-transition on merge + linked-git panel), #46 (ADR 0001 + per-project connections + outbound commit status) · remaining: connect/configure UI + multi-provider · **Depends on:** F2, F5, F12 · **Size:** L
